...
const productsByCategory: { [key: string]: { subcategories: { name: string; products: any[] }[] } } = {
  "CBD CANABIDIOL": { subcategories: [{ name: "Produtos CBD", products: [ { name: "Óleo CBD 10%", description: "30ml", price: "R$ 299,90", image: "/placeholder.svg" }, { name: "Cápsulas CBD", description: "30 cápsulas", price: "R$ 349,90", image: "/placeholder.svg" } ] }] },
  "PRODUTOS EMAGRECEDORES": { subcategories: [{ name: "Emagrecedores", products: [{ name: "Emagrecedor Lipo-6", description: "60 cápsulas", price: "R$ 189,90", image: "/placeholder.svg" }] }] },
  "PRODUTOS DE FARMÁCIA": { subcategories: [{ name: "Farmácia", products: [ { name: "Analgésico Forte", description: "20 comprimidos", price: "R$ 29,90", image: "/placeholder.svg" }, { name: "Vitamina C", description: "60 comprimidos", price: "R$ 49,90", image: "/placeholder.svg" } ] }] },
  "PRODUTOS MANIPULADOS": { subcategories: [{ name: "Manipulados", products: [{ name: "Fórmula da Energia", description: "60 doses", price: "R$ 150,00", image: "/placeholder.svg" }] }] },
  "PRODUTOS VARIADOS": { subcategories: [{ name: "Variados", products: [{ name: "Shaker", description: "600ml", price: "R$ 35,00", image: "/placeholder.svg" }] }] },
  "SARMS": { subcategories: [{ name: "SARMs", products: [{ name: "Ostarine MK-2866", description: "60 cápsulas", price: "R$ 250,00", image: "/placeholder.svg" }] }] },
};
