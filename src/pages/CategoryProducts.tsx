...
const productsByCategory: { [key: string]: { subcategories: { name: string; products: any[] }[] } } = {
  ...
  "PRODUTOS DE FARMÁCIA": { subcategories: [{ name: "Produtos Injetáveis", products: [] }, { name: "Produtos Orais", products: [ { name: "Analgésico Forte", description: "20 comprimidos", price: "R$ 29,90", image: "/placeholder.svg" }, { name: "Vitamina C", description: "60 comprimidos", price: "R$ 49,90", image: "/placeholder.svg" }, { name: "Relaxante Muscular", description: "10 comprimidos", price: "R$ 19,90", image: "/placeholder.svg" } ] }] },
  ...
  "PRODUTOS VARIADOS": { subcategories: [{ name: "Produtos Injetáveis", products: [] }, { name: "Produtos Orais", products: [{ name: "Shaker", description: "600ml", price: "R$ 35,00", image: "/placeholder.svg" }, { name: "Luvas de Treino", description: "Par", price: "R$ 55,00", image: "/placeholder.svg" }] }] },
  "SARMS": { subcategories: [{ name: "Produtos Injetáveis", products: [] }, { name: "Produtos Orais", products: [{ name: "Ostarine MK-2866", description: "60 cápsulas", price: "R$ 250,00", image: "/placeholder.svg" }, { name: "Ligandrol LGD-4033", description: "60 cápsulas", price: "R$ 280,00", image: "/placeholder.svg" }] }] },
};
