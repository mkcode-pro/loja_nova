  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="p-4 space-y-6 pb-24 md:pb-6 flex-grow">
        ...
        <section>
          <h2 className="text-lg font-bold text-center text-primary">MARCAS</h2>
          <p className="text-center text-muted-foreground mb-4">Nossas Marcas</p>
        ...
        <section>
          <h2 className="text-lg font-bold text-center text-primary mt-6">Marcas Premium</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-center text-primary mt-6">Marcas Nacionais</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-center text-primary mt-6">Diversos</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-center text-primary mt-6">Garantias & Proteções</h2>
